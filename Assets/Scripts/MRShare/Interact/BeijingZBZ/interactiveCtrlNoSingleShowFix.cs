...
namespace HoloShare
{
    public class interactiveCtrlNoSingleShowFix : SingletonMono<interactiveCtrlNoSingleShowFix>
    {
        private AnimotionTouchNoSingleShowFix animatorTouchSingleShow;

        public AnimotionTouchNoSingleShowFix AnimatorTouchSingleShow
        {
