...
namespace GF
{
    public static class GameViewUtils
    {
        ...
        public static bool TrySetSize(string sizeText, GameViewSizeGroupType gameViewSizeGroupType = GameViewSizeGroupType.Standalone)
        {
            int foundIndex = FindSize(gameViewSizeGroupType, sizeText);
            if (foundIndex < 0)
            {
